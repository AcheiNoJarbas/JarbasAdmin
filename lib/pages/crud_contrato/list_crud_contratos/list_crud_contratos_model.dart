...
import 'dart:ui';
import 'list_crud_contratos_widget.dart' show ListCrudContratosWidget;
...
class ListCrudContratosModel extends FlutterFlowModel<ListCrudContratosWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in listCrudContratos widget.
  List<ContratacoesRecord>? lisOfContratos;
