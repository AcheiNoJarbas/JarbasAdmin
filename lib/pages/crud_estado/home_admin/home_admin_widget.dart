            ...
            children: [
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Text(
                                          ...
                                          }(functions.getRendaTotal(_model.empresas!.toList()).toString())}',
                                          style: FlutterFlowTheme.of(context)
                                              .displaySmall
                                              .override(
                                                fontFamily: 'Lexend',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    FutureBuilder<int>(
                      future: queryBairrosRecordCount(),
                      builder: (context, snapshot) {
                        ...
                        int incomeCardCount = snapshot.data!;
                    ...
                    FutureBuilder<int>(
                      future: queryMunicipiosRecordCount(),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                        ...
                        int spendingCardCount = snapshot.data!;
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    FutureBuilder<int>(
                      future: queryEmpresasRecordCount(),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                    ...
                    FutureBuilder<int>(
                      future: queryContratacoesRecordCount(),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                    ...
                    FutureBuilder<int>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed('empresasListDestaque');
                          },
                          child: Container(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 16.0, 10.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
