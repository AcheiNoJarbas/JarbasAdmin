...
import 'dart:ui';
import 'list_crud_categorias_widget.dart' show ListCrudCategoriasWidget;
...
class ListCrudCategoriasModel
    extends FlutterFlowModel<ListCrudCategoriasWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in listCrudCategorias widget.
  List<CategoriasRecord>? listOfcategorias;
  // Model for backButton component.
  late BackButtonModel backButtonModel;
  // Model for Title component.
  late TitleModel titleModel;
  // Models for CardCategoria dynamic component.
  late FlutterFlowDynamicModels<CardCategoriaModel> cardCategoriaModels;
  ...
  void initState(BuildContext context) {
    ...
    cardCategoriaModels = FlutterFlowDynamicModels(() => CardCategoriaModel());
